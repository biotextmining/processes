...
public class FGOCrawling extends IRProcessImpl implements IIRCrawl{
	...
	protected File getPDFAndUpdateReportUsingPatentID(String patentID,String saveDocDirectoty, long pubID) throws ANoteException{
		try {
			FGOPatentDataObject fgoOPatentDataObject = FGOParser.retrieveFullInformation(patentID);
			if(fgoOPatentDataObject==null)
				return null;
			String fullTextContent = fgoOPatentDataObject.getTextContent();
