...
public class NewPubMedCrawl extends IRProcessImpl implements IIRCrawl{
	...
	private Set<String> getAllFreeFullTextPMID(List<IPublication> publications) throws ANoteException, InternetConnectionProblemException {
		...
		query = query + ")";
		Set<String> result = NewPMSearch.getPublicationAvailableFreeFullText(query);
		return result;
	}
	...
	public static File downloadPDF(IPublication pub, String pmid, String path) {
		...
		if (NewWebConnectionConsole.buscarPDF(pub,path, pmid)) {
