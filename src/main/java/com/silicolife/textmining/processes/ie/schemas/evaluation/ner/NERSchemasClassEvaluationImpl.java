...
import com.silicolife.textmining.core.interfaces.process.IE.ner.INERClassEvaluation;
...
public class NERSchemasClassEvaluationImpl extends EvaluationImpl implements INERSchemaEvaluation{

	private NERSchemasEvaluationResultsImpl results;
	
	public NERSchemasClassEvaluationImpl(NERSchemasEvaluationResultsImpl results) {
	...
	@Override
	public List<IEntityAnnotation> getAditionalgEntitiesInStandard() {
	...
	public INERClassEvaluation getClassTypeScores(){
