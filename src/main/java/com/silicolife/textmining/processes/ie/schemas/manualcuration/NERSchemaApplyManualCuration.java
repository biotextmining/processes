			...
			if(addEntity!=null)
			{
				...
				if(!annotPositions.containsConflits(entPOs))
				{
					...
					IEntityAnnotation newAddEntity = new EntityAnnotationImpl(addEntity.getStartOffset(),
							addEntity.getEndOffset(), addEntity.getClassAnnotation(), addEntity.getResourceElement(), addEntity.getAnnotationValue(), addEntity.getAnnotationValueNormalization(),addEntity.getProperties());			
