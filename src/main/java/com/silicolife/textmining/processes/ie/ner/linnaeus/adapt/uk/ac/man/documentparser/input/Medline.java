...
public class Medline implements DocumentIterator {
	...
	public com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.uk.ac.man.documentparser.dataholders.Document next() {
		...
		ExternalID externalID = new ExternalID(ID, com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.uk.ac.man.documentparser.dataholders.ExternalID.Source.MEDLINE);
