package com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.uk.ac.man.documentparser.misc;
...
public class MedlineFixer {
	public static void main(String[] args){
		...
		if (ap.containsKey("deleteRows")){
			MyConnection conn = com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.martin.common.SQL.connectMySQL2(ap, logger, "farzin");
