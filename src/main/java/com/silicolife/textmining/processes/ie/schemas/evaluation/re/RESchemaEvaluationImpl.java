...
import com.silicolife.textmining.core.interfaces.process.IE.re.IREClassTypesEvaluation;
...
import com.silicolife.textmining.processes.ie.schemas.evaluation.EvaluationImpl;

public class RESchemaEvaluationImpl extends EvaluationImpl implements IRESchemaEvaluation{
	
	private RESchemasEvaluationResults results;


	public RESchemaEvaluationImpl(RESchemasEvaluationResults results) {
		super(calculatePrecision(results),calculateRecall(results),calculateFscore(results));
		this.results = results;
	}

	private static float calculateFscore(RESchemasEvaluationResults results) {
	...
	// Precisao
	private static float calculatePrecision(RESchemasEvaluationResults results) {
	...
	// Acerto
	private static float calculateRecall(RESchemasEvaluationResults results) {
