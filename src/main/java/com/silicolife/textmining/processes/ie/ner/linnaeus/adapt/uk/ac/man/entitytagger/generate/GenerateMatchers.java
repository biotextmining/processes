package com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.uk.ac.man.entitytagger.generate;
...
import com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.dk.brics.automaton.Automaton;
...
import com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.martin.common.StreamIterator;
import com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.martin.common.Tuple;
	...
	public static void main(String[] args) {
		...
		if (ap.containsKey("species") || ap.containsKey("genus") || ap.containsKey("regexp")){
			...
			if (ap.containsKey("species"))
				dict = com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.uk.ac.man.entitytagger.entities.species.GenerateDictionary.generateSpeciesDictionary(ap.getFile("species"), extraSynonymFiles, includeLineNumbers, logger, report);
			if (ap.containsKey("genus"))
				dict = com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.uk.ac.man.entitytagger.entities.species.GenerateDictionary.generateGenusDictionary(ap.getFile("genus"), extraSynonymFiles, includeLineNumbers, logger);
			...
			if (ap.containsKey("convertToVariants") || ap.containsKey("convertToVariantsDB")){
				...
				PreparedStatement pstmt = ap.containsKey("convertToVariantsDB") ? initVariantTable(com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.martin.common.SQL.connectMySQL(ap, logger, "dictionaries"), ap.get("convertToVariantsDB"), true) : null;
