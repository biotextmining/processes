package com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.dk.brics.automaton;
...
final public class StringUnionOperations {
	 ...
	 */
	private static com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.dk.brics.automaton.State convert(State s, 
			IdentityHashMap<State, com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.dk.brics.automaton.State> visited) {
		com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.dk.brics.automaton.State converted = visited.get(s);
		if (converted != null)
			return converted;

		converted = new com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.dk.brics.automaton.State();
	 ...
	 */
	public static com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.dk.brics.automaton.State build(CharSequence[] input) {
		final StringUnionOperations builder = new StringUnionOperations(); 

		for (CharSequence chs : input)
			builder.add(chs);

		return convert(builder.complete(), new IdentityHashMap<State, com.silicolife.textmining.processes.ie.ner.linnaeus.adapt.dk.brics.automaton.State>());
	}
