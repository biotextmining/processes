...
public class Postprocessor {
	 ...
	 * @author Hugo Costa
	 * 
	 * @param stopTermStreams
	 * @param acronymProbStreams
	 * @param entityFrequencyStreams
	 * @param comments
	 * @param logger
	 */
	public Postprocessor(InputStream[] stopTermStreams){

		this.stopTerms = stopTermStreams != null ? loadStopTerms(stopTermStreams) : null;
		this.acronymProbabilities = null;
		this.entityFrequencies = null;
