...
public class NERSchemaEvaluationImpl extends EvaluationImpl implements INERSchemaEvaluation{

	private NERSchemasEvaluationResultsImpl results;
	
	public NERSchemaEvaluationImpl(NERSchemasEvaluationResultsImpl results) {
